      ...
      (enlivenedObjects: fabric.Object[]) => {
        enlivenedObjects.forEach((enlivenedObj) => {
          ...
          if (activeObjectRef.current?.objectId === objectId) {
            fabricRef.current?.setActiveObject(enlivenedObj as fabric.Object)
          }

          // add object to canvas
          fabricRef.current?.add(enlivenedObj as fabric.Object)
        })
      },
      /**
...
export const handleCanvasZoom = ({
  ...
  canvas.zoomToPoint(new fabric.Point(options.e.offsetX, options.e.offsetY), zoom)
